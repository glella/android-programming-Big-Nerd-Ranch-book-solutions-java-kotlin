...
class QuizActivity : AppCompatActivity() {
    ...
    private val KEY_CHEAT_COUNT = "cheat_count"
    private var mCurrentCheatCount = MAX_CHEATS
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        remaining_cheats_text_view?.setText("Remaining Cheats: " + mCurrentCheatCount.toString())
