...
public class CrimeListFragment extends Fragment {
    ...
    private class CrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(Crime crime) {
            ...
            // Challenge
            //mDateTextView.setText(mCrime.getDate().toString()); // Old line
            String pattern = "EEEE, MMMM dd, yyyy";
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
            String dateString = simpleDateFormat.format(mCrime.getDate());
            // Another alternative:
            //String dateString = DateFormat.getPatternInstance(DateFormat.ABBR_MONTH_WEEKDAY_DAY).format(mCrime.getDate());
